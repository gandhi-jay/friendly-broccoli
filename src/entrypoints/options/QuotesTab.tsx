      ...
      {data.disableApiQuotes ? (
        <>
          <p className="text-sm text-secondary mb-3">
            Motivational quotes shown on the blocked page. Add your own or edit
            the defaults.
          </p>
        ...
        <p className="text-sm text-secondary mb-3">
          ...
          via an LRU cache (max 50 quotes, refilled when pool drops below 8).
          Falls back to your local list if the API is unavailable.
        </p>
      )}
    </div>
  );
